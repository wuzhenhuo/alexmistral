...
model_options = ('mistral-tiny', 'mistral-small', 'mistral-medium','mistral-large-latest','codestral-mamba-latest','mistral-large-2407','mistral-large-latest','pixtral-large-latest')
